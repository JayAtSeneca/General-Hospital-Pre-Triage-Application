...
Hospitals must screen patients and distinguish between those who require a COVID test and others in order to contain the pandemic and stop the spread of COVID19. To avoid lines, this must be done in a timely manner by informing the patients of the estimated wait time and the time when they can be admitted. 
